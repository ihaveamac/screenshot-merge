...
doubleDraw(function()
    ...
    print(5, 95, "If this folder exists, you should back it")
    print(5, 110, "up to prevent conflicts.")
    print(5, 130, "Only those with a top and bottom image")
    print(5, 145, "will be merged.")
    print(5, 185, "A: next")
    print(5, 200, "B: exit")
end)
repeat
...
doubleDraw(function()
    ...
    print(5, 40, "format in the \""..output_folder.."\".")
...
doubleDraw(function()
    ...
    if overwriting_files then
        ...
        print(5, 130, "It is highly recommended to move the")
...
doubleDraw(function()
    ...
    if System.doesFileExist("/gridlauncher/glinfo.txt") then
        print(5, 120, "If you are using mashers's grid launcher,")
        print(5, 135, "you should use the exit shortcut instead.")
        print(5, 155, "ninjhax 2.5 exit shortcut: L+R+Down+B")
    end
end)
while true do
    pad = Controls.read()
